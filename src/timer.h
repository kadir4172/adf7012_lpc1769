...
extern _Bool Init_Timer(uint32_t timerInterval );
extern _Bool Enable_Timer(void);
extern _Bool Disable_Timer(void);
extern _Bool Reset_Timer(void);
extern void TIMER0_IRQHandler (void);
extern void TIMER1_IRQHandler (void);
extern void TIMER2_IRQHandler (void);
extern void TIMER3_IRQHandler (void);

//extern uint32_t audio_signal;
#endif /* end __TIMER_H */
/*****************************************************************************
**                            End Of File
******************************************************************************/
